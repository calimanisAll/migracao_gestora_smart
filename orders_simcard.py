    ...
    for order in orders:
        try:
            ...
            if not franchise_result:
                raise ValueError(f"Franquia não encontrada para o valor: {franchise_value} e tipo: {franchise_type}")
            ...
            if variable2_order is None:
                raise ValueError(f"Valor de variable2_order inválido: {order['variable2_order']}")
